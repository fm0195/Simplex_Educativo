 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({pruebas.SolucionadorSimplexSiguientePasoTest.class, pruebas.AgregarNombreWTest.class,
    pruebas.SolucionadorSimplexCalcularRadiosTest.class, pruebas.SolucionadorGomorySolucionarTest.class, 
    ...
    pruebas.EsAcotadoTest.class, pruebas.AgregarUnosTest.class,pruebas.BuscarIndiceTest.class, 
    pruebas.FraccionTest.class,
    pruebas.SolucionadorSimplexCompletarProblemaTest.class, pruebas.AgregarNombreVariablesTest.class, pruebas.ConvertirDosFasesTest.class,
    pruebas.AgregarNombresFilaTest.class})
