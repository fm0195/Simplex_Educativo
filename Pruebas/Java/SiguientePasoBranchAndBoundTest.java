...
public class SiguientePasoBranchAndBoundTest {

    DtoSimplex problema;
    String arbol;
    String mensaje;

    public SiguientePasoBranchAndBoundTest(DtoSimplex problema, String arbol, String mensaje) {
    ...
    public void test() {
        ...
        DtoSimplex solucion = pasos.get(paso);
    ...
    public static Collection parametros() throws IOException {
        ...
        String arbol1 = "Problema 1\n"
                ...
                + "\n"
                + "";
        String mensaje1 = "Se iteró sobre el arbol de soluciones.\n"
                + " Siguiente Iteración :Problema 1.2\n"
                + "Sobre la variable: x1\n"
                + "";
        String arbol2 = "Problema 1\n"
                ...
                + "\n"
                + "";
        String mensaje2 = "Se iteró sobre el arbol de soluciones.\n"
                + " Siguiente Iteración :Problema 1.1\n"
                + "Sobre la variable: x2\n"
                + "";
