...
/**
 *
 * @author Fernando Molina Una clase que representa los posibles tokens para el
 * parseo de un problema de programacion lineal.
 */
public class SimplexSymbol extends java_cup.runtime.Symbol {
     ...
     * @param line linea donde se encuentra en el string original
     * @param column columna donde se encuentra en el string original
     * @param value un valor que posee el token. Puede ser un valor numerico en
     * el caso de coeficientes o un string en el caso de variables.
     */
