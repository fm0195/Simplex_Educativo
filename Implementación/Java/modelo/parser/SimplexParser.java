...
public class SimplexParser extends java_cup.runtime.lr_parser implements IParser {
     ...
     */
    @Deprecated
    public SimplexParser(java_cup.runtime.Scanner s) {
        super(s);
    }
     ...
     * Constructor which sets the default scanner.
     */
    public SimplexParser(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf) {
        super(s, sf);
    }
    ...
    private SimplexParser(Scanner s) {
        super(s);
        this.s = s;
    }
